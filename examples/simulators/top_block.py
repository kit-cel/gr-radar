...
# Title: Top Block
# Generated: Thu Jul 10 13:04:59 2014
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_static_target_simulator_cc_0 = radar.static_target_simulator_cc((5000, 5000), (vel, vel), (1e20, 1e20), (0,20), samp_rate, center_freq, -10, False, False, "packet_len")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.radar_static_target_simulator_cc_0.setup_targets((5000, 5000), (self.vel, self.vel), (1e20, 1e20), (0,20), self.samp_rate, self.center_freq, -10, False, False)
