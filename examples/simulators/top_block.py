...
# Title: Top Block
# Generated: Thu Jul 10 17:27:55 2014
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_static_target_simulator_cc_0 = radar.static_target_simulator_cc((Range,), (vel, ), (1e14, ), (0,), samp_rate, center_freq, -10, True, True, "packet_len")
        ...
        self.radar_os_cfar_c_0 = radar.os_cfar_c(samp_rate/decim_fac, 10, 0, 0.78, 20, True, "packet_len")
        (self.radar_os_cfar_c_0).set_min_output_buffer(1048576)
        ...
        self.connect((self.blocks_multiply_conjugate_cc_1, 0), (self.radar_os_cfar_c_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.radar_static_target_simulator_cc_0.setup_targets((self.Range,), (self.vel, ), (1e14, ), (0,), self.samp_rate, self.center_freq, -10, True, True)
