...
# Title: Top Block
# Generated: Sun Jul  6 17:18:02 2014
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq = freq = (-samp_rate/4,samp_rate/4)
        ...
        self.range_res = range_res = 3e8/float((freq[1]-freq[0]))
        ...
        self._vel_counter.setRange(-50, 50, 1)
        ...
        self._vel_slider.setRange(-50, 50, 1)
        ...
        self.radar_static_target_simulator_cc_0 = radar.static_target_simulator_cc((10, 10), (vel, 0), (1e12, 1e12), (0, 0), samp_rate, center_freq, -10, False, False, "packet_len")
        (self.radar_static_target_simulator_cc_0).set_min_output_buffer(2097152)
        ...
        self.radar_qtgui_time_plot_0 = radar.qtgui_time_plot(250, 'velocity', (-50,50), 10, "")
        self.radar_qtgui_scatter_plot_0 = radar.qtgui_scatter_plot(250, 'velocity', 'y', (-50,50), (-1,1), "")
        ...
        (self.radar_os_cfar_c_0).set_min_output_buffer(2097152)
        self.radar_estimator_cw_0 = radar.estimator_cw(center_freq)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        (self.blocks_throttle_0).set_min_output_buffer(2097152)
        ...
        (self.analog_noise_source_x_0).set_min_output_buffer(2097152)
        ...
        self.msg_connect(self.radar_estimator_cw_0, "Msg out", self.radar_qtgui_scatter_plot_0, "Msg in")
        self.msg_connect(self.radar_estimator_cw_0, "Msg out", self.radar_qtgui_time_plot_0, "Msg in")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_freq((-self.samp_rate/4,self.samp_rate/4))
        self.set_freq_res(self.samp_rate/float(self.packet_len))
        self.set_time_res(self.packet_len/float(self.samp_rate))
        self.blocks_throttle_0.set_sample_rate(self.samp_rate)
        self.radar_static_target_simulator_cc_0.setup_targets((10, 10), (self.vel, 0), (1e12, 1e12), (0, 0), self.samp_rate, self.center_freq, -10, False, False)
    ...
    def set_freq(self, freq):
        self.freq = freq
        self.set_range_res(3e8/float((self.freq[1]-self.freq[0])))
