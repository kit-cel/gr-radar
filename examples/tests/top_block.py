...
# Title: Top Block
# Generated: Sun Jul  6 17:38:00 2014
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_usrp_echotimer_cc_0 = radar.usrp_echotimer_cc(1, samp_rate, center_freq, int(num_delay_samps), 'addr=192.168.10.6', '', 'internal', 'none', 'J1', 0, 0.1, wait_to_start, 0, 'addr=192.168.10.4', '', 'mimo', 'mimo', 'J1', 0, 0.1, wait_to_start, samp_rate/2, "packet_len")
