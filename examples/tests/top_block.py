...
# Title: Top Block
# Generated: Sat Jul 12 19:59:07 2014
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.const_mult = const_mult = 1
        self.const_add = const_add = -20
        ...
        self._const_mult_layout = Qt.QVBoxLayout()
        self._const_mult_tool_bar = Qt.QToolBar(self)
        self._const_mult_layout.addWidget(self._const_mult_tool_bar)
        self._const_mult_tool_bar.addWidget(Qt.QLabel("const_mult"+": "))
        class qwt_counter_pyslot(Qwt.QwtCounter):
            def __init__(self, parent=None):
                Qwt.QwtCounter.__init__(self, parent)
            @pyqtSlot('double')
            def setValue(self, value):
                super(Qwt.QwtCounter, self).setValue(value)
        self._const_mult_counter = qwt_counter_pyslot()
        self._const_mult_counter.setRange(-100, 100, 1)
        self._const_mult_counter.setNumButtons(2)
        self._const_mult_counter.setValue(self.const_mult)
        self._const_mult_tool_bar.addWidget(self._const_mult_counter)
        self._const_mult_counter.valueChanged.connect(self.set_const_mult)
        self._const_mult_slider = Qwt.QwtSlider(None, Qt.Qt.Horizontal, Qwt.QwtSlider.BottomScale, Qwt.QwtSlider.BgSlot)
        self._const_mult_slider.setRange(-100, 100, 1)
        self._const_mult_slider.setValue(self.const_mult)
        self._const_mult_slider.setMinimumWidth(200)
        self._const_mult_slider.valueChanged.connect(self.set_const_mult)
        self._const_mult_layout.addWidget(self._const_mult_slider)
        self.top_layout.addLayout(self._const_mult_layout)
        self._const_add_layout = Qt.QVBoxLayout()
        self._const_add_tool_bar = Qt.QToolBar(self)
        self._const_add_layout.addWidget(self._const_add_tool_bar)
        self._const_add_tool_bar.addWidget(Qt.QLabel("const_add"+": "))
        class qwt_counter_pyslot(Qwt.QwtCounter):
            def __init__(self, parent=None):
                Qwt.QwtCounter.__init__(self, parent)
            @pyqtSlot('double')
            def setValue(self, value):
                super(Qwt.QwtCounter, self).setValue(value)
        self._const_add_counter = qwt_counter_pyslot()
        self._const_add_counter.setRange(-100, 100, 1)
        self._const_add_counter.setNumButtons(2)
        self._const_add_counter.setValue(self.const_add)
        self._const_add_tool_bar.addWidget(self._const_add_counter)
        self._const_add_counter.valueChanged.connect(self.set_const_add)
        self._const_add_slider = Qwt.QwtSlider(None, Qt.Qt.Horizontal, Qwt.QwtSlider.BottomScale, Qwt.QwtSlider.BgSlot)
        self._const_add_slider.setRange(-100, 100, 1)
        self._const_add_slider.setValue(self.const_add)
        self._const_add_slider.setMinimumWidth(200)
        self._const_add_slider.valueChanged.connect(self.set_const_add)
        self._const_add_layout.addWidget(self._const_add_slider)
        self.top_layout.addLayout(self._const_add_layout)
        ...
        self.radar_static_target_simulator_cc_0 = radar.static_target_simulator_cc((Range,), (vel, ), (1e22, ), (0,), samp_rate, center_freq, -10, True, False, "packet_len")
        ...
        self.radar_msg_manipulator_0 = radar.msg_manipulator(('velocity',), ((const_add,)), ((const_mult,)))
        ...
        self.msg_connect(self.radar_estimator_cw_0, "Msg out", self.radar_msg_manipulator_0, "Msg in")
    ...
    def get_const_mult(self):
        return self.const_mult

    def set_const_mult(self, const_mult):
        self.const_mult = const_mult
        Qt.QMetaObject.invokeMethod(self._const_mult_counter, "setValue", Qt.Q_ARG("double", self.const_mult))
        Qt.QMetaObject.invokeMethod(self._const_mult_slider, "setValue", Qt.Q_ARG("double", self.const_mult))
        self.radar_msg_manipulator_0.set_const_mult(((self.const_mult,)))

    def get_const_add(self):
        return self.const_add

    def set_const_add(self, const_add):
        self.const_add = const_add
        Qt.QMetaObject.invokeMethod(self._const_add_counter, "setValue", Qt.Q_ARG("double", self.const_add))
        Qt.QMetaObject.invokeMethod(self._const_add_slider, "setValue", Qt.Q_ARG("double", self.const_add))
        self.radar_msg_manipulator_0.set_const_add(((self.const_add,)))
