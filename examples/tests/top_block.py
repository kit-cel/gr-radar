...
# Title: Top Block
# Generated: Tue Jun 24 15:48:17 2014
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_tracking_particle_singletarget_0 = radar.tracking_particle_singletarget(0, 0, 0)
        ...
        self.radar_qtgui_time_plot_0_1 = radar.qtgui_time_plot(250, 'velocity', (-30,30), 10, "BEFORE TRACKING")
        self.radar_qtgui_time_plot_0_0_0 = radar.qtgui_time_plot(250, 'range', (0,120), 10, "BEFORE TRACKING")
        self.radar_qtgui_time_plot_0_0 = radar.qtgui_time_plot(250, 'range', (0,120), 10, "AFTER TRACKING")
        self.radar_qtgui_time_plot_0 = radar.qtgui_time_plot(250, 'velocity', (-30,30), 10, "AFTER TRACKING")
        self.radar_find_max_peak_c_0 = radar.find_max_peak_c(samp_rate/decimator_fac/2, -120, 0, "packet_len")
        ...
        self.msg_connect(self.radar_tracking_particle_singletarget_0, "Msg out", self.radar_qtgui_time_plot_0, "Msg in")
        self.msg_connect(self.radar_tracking_particle_singletarget_0, "Msg out", self.radar_qtgui_time_plot_0_0, "Msg in")
        self.msg_connect(self.radar_estimator_fsk_0, "Msg out", self.radar_qtgui_time_plot_0_1, "Msg in")
